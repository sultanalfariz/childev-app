@extends('childev.guardian.akun.index')
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">351016080780012</div>
                </div>

                <div class="row">
                    <div class="col-lg-3 col-md-4 label">Tanggal Lahir</div>
                    <div class="col-lg-9 col-md-8">10-04-1989</div>
                </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="about" type="text" class="form-control" id="about" value="351019180820019">
                      </div>
                    </div>
